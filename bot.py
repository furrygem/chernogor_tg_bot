...
ZAPOVEDI = [
    ...
    "Кто рано встает - тот весь день жалеет",
    "Если работа сама не ушла - уйди ты, будь выше",
    "Не спеши к делу: оно не волк, а если волк - тем более не ходи.",
    "Лучший инструмент мудреца - подушка, остальное от лукавого",
    "Не спеши делать сегодня то, что можно с чистой совестью не сделать и завтра.",
    "Если рука тянется к труду — положи ее на живот и успокой.",
]
